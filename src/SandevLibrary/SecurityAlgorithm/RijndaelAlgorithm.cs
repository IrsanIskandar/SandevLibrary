...
namespace SandevLibrary.SecurityAlgorithm
{
    ...
    {
        private const string passPhrase = "TestPassphrase";        // can be any string
        private const string saltValue = "TestSaltValue";        // can be any string
        private const string hashAlgorithm = "SHA256";             // can be "MD5"
        private static int passwordIterations = 2;                // can be any number
        private const string initVector = "!1A3g2D4s9K556g7"; // must be 16 bytes
