...
namespace SandevLibrary.FilesExtensions.ExportImportFilesPOI
{
    public class ExcelWorkbookServicePOI
    {
                                                    ...
                                                    case CellType.Numeric:
                                                        ...
                                                        else
                                                        {
                                                            if (format == 49)
                                                            {
                                                                ...
                                                                {
                                                                    DateTime dateTime = (DateTime)cell.DateCellValue;
        ...
        public static bool DataTableToExcel(DataSet dataSet, string Outpath)
        {
            ...
            try
            {
                ...
                {
                    workbook.Write(fs, false);//Write data to the opened xls file
                    result = true;
                }
                return result;
            }
